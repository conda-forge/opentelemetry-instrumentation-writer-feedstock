About opentelemetry-instrumentation-writer-feedstock
====================================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/opentelemetry-instrumentation-writer-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/opentelemetry-instrumentation-writer-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add opentelemetry-instrumentation-writer
# for installing globally
pixi global install opentelemetry-instrumentation-writer
```
...
It is possible to list all of the versions of `opentelemetry-instrumentation-writer` available on your platform:
...
```
pixi search opentelemetry-instrumentation-writer --channel conda-forge
```
